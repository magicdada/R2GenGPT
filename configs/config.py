...
parser.add_argument('--annotation', type=str, default=r'./data/iu_xray/annotation.json')
parser.add_argument('--base_dir', type=str, default=r'./data/iu_xray/images')
...
parser.add_argument('--low_resource', default=True, type=lambda x: (str(x).lower() == 'true'))
parser.add_argument('--end_sym', default='</s>', type=str)

# ======================== SavedModel Configs ===========================
# parser.add_argument('--savedmodel_path', type=str, default='save/mimic/v1')
# parser.add_argument('--savedmodel_path', type=str, default='save/iu_xray/v1_delta')
parser.add_argument('--savedmodel_path', type=str, default='save/iu_xray/v1_deep')
